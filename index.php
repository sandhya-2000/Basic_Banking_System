...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">SPARKS BANK <img src="logos/logo.webp" alt="Bank" width="40" height="40"></a>
	...
	<div class="text-center p-3" style="background-color:black">
        <h2>
		    <strong>The Friendlier, Easier Place to Bank!!!</strong> </h2></div>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/2.jpg" width="500" height="507" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/bg1.jpg" width="500" height="507" class="d-block w-100" alt="...">
