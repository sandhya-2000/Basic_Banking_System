...
<body>
 ...
 <div class="container">
        ...
        <h2 class="text-center pt-4" style="color : white;">Transer Money Here !</h2>
        <label style="color : white;"><strong>Transfer To:</strong></label>
        <select style="background-color:white" name="to" class="form-control" required>
        ...
        <br>
        <br>
            <label style="color : white;"><strong>Amount:</strong></label>
            <input type="number" class="form-control" name="amount" required>   
            <br><br>
                <div class="text-center" >
                <button class="btn btn-outline-light mb-3" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>    
